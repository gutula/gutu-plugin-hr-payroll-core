...
| Primary focus | employees, payroll runs, leave state |
...
| Field | Value |
| --- | --- |
| Package | `@plugins/hr-payroll-core` |
...
| Owned Entities | 7 | `Employee`, `Attendance`, `Leave Ledger`, `Payroll Run`, `Salary Structure`, `Expense Claim`, `Loan or Advance` |
| Reports | 5 | `Payroll Register`, `Salary Register`, `Leave Ledger`, `Expense Claim Summary`, `Attendance Summary` |
| Exception Queues | 4 | `payroll-lock-review`, `retro-pay-adjustments`, `leave-balance-corrections`, `payout-failure-review` |
| Operational Scenarios | 5 | `employee-onboarding`, `leave-approval`, `payroll-processing`, `expense-claim-reimbursement`, `off-cycle-payroll` |
| Settings Surfaces | 4 | `Payroll Settings`, `Salary Structure`, `Leave Type`, `Shift Type` |
| ERPNext Refs | 4 | `HR`, `Payroll`, `Projects`, `Manufacturing` |
...
Use the root repo scripts for day-to-day work **after the workspace is bootstrapped**, or run the nested package directly from `framework/builtin-plugins/hr-payroll-core` if you need lower-level control.
...
- `plugins/gutu-plugin-hr-payroll-core/framework/builtin-plugins/hr-payroll-core/docs/AGENT_CONTEXT.md`
- `plugins/gutu-plugin-hr-payroll-core/framework/builtin-plugins/hr-payroll-core/docs/BUSINESS_RULES.md`
- `plugins/gutu-plugin-hr-payroll-core/framework/builtin-plugins/hr-payroll-core/docs/EDGE_CASES.md`
- `plugins/gutu-plugin-hr-payroll-core/framework/builtin-plugins/hr-payroll-core/docs/FLOWS.md`
- `plugins/gutu-plugin-hr-payroll-core/framework/builtin-plugins/hr-payroll-core/docs/GLOSSARY.md`
- `plugins/gutu-plugin-hr-payroll-core/framework/builtin-plugins/hr-payroll-core/docs/MANDATORY_STEPS.md`
