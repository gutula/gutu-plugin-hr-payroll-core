# HR & Payroll Core Mandatory Steps

## Before shipping a change

1. Update the public contract docs in `README.md` and `DEVELOPER.md`.
2. Keep the nested docs under `framework/builtin-plugins/hr-payroll-core/docs` synchronized with the same truth.
...
1. Depend on the manifest ID `hr-payroll-core` and the package import `@plugins/hr-payroll-core`.
