...
export const primaryRecordsTable = pgTable("hr_payroll_core_primary_records", {
...
export const secondaryRecordsTable = pgTable("hr_payroll_core_secondary_records", {
  id: text("id").primaryKey(),
  tenantId: text("tenant_id").notNull(),
...
export const exceptionRecordsTable = pgTable("hr_payroll_core_exception_records", {
  id: text("id").primaryKey(),
  tenantId: text("tenant_id").notNull(),
  primaryRecordId: text("primary_record_id").notNull(),
