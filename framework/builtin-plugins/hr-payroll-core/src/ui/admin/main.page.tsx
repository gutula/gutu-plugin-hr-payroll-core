...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "HR & Payroll Control Room"),
    React.createElement("p", null, "Workforce truth, leave posture, payroll runs, and payout or correction visibility."),
    React.createElement(
      "p",
      null,
