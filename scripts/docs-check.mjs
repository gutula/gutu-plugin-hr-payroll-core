...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/hr-payroll-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-hr-payroll-core:");
...
console.log("Documentation check passed for gutu-plugin-hr-payroll-core.");
